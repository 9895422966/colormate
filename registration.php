...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <a href="dregistration.php" class="appointment-btn ">Sign Up as Doctor</a>
      ...
      <div class="container" data-aos="fade-down">
        ...
        <div class="row">
          <div class="col-md-6 offset-md-3 col mt-5 mt-lg-0 d-flex align-items-stretch">
            ...
            <form method="POST" action="php/phpsendotp.php" autocomplete="off" class="form-box" onsubmit="return(dataCheck())">
