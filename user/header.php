...
<body>
  ...
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="index.php" class="logo"><b>Colormate<span class="lite"> User</span></b></a>
      <!--logo end-->
    ...
    <aside>
      <div id="sidebar" class="nav-collapse " style="">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="">
            <a class="" href="mytest.php">
                          <i class="fa fa-user-md"></i>
                          <span>My Test</span>
                      </a>
          </li>
          <li class="">
            <a class="" href="mydoctor.php">
                          <i class="fa fa-user-md"></i>
                          <span>My Doctors</span>
                      </a>
          </li>
          <li class="active">
            <a class="" href="starttest.php">
                          <i class="fa fa-user-md"></i>
