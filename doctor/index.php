<?php
 require 'header.php';
 $j=select1("select COUNT(*) from user_reg WHERE doc_id='$doc_id'");
 $v=select1("select COUNT(*) from test_details where doc_id='$doc_id'and status='1';");
 $i=select1("select COUNT(*) from test_details where doc_id='$doc_id' and status='0';");
        ...
        <div class="row">
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
            <div class="info-box blue-bg">
              ...
              <div class="title">Total Paients</div>
            </div>
            <!--/.info-box-->
          </div>
          <!--/.col-->
          ...
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <div class="info-box red-bg">
              ...
              <div class="title">Pending Test</div>
            </div>
            <!--/.info-box-->
          </div>
          <!--/.col-->
          ...
          <div class="col-md-12">
            <div class="panel panel-default">
              <div class="panel-heading">
                <h2><i class="fa fa-flag-o red"></i><strong>My Patients</strong></h2>
              ...
              <div class="panel-body">
                <table class="table table-striped bootstrap-datatable countries" id="countries">
                  ...
                  <tbody>
                    <?php
                     $q=mysqli_query($connect,"select * from user_reg WHERE doc_id='$doc_id'");
