<?php
  ...
  $toverify=select1("select COUNT(*) from test_details where doc_id='$doc_id' and status='0';");
...
<body>
  ...
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="index.php" class="logo"><b>Colormate<span class="lite"> Doctor</span></b></a>
      <!--logo end-->
        ...
        <ul class="nav top-menu">
          <li>
            <form class="navbar-form" method="get" action="search.php">
              <input class="form-control" placeholder="Search" type="text" name="key" minlength="3">
              <button type="submit" style="background-color: transparent;border:0;"><i style="margin-left: -40px; margin-top:10px;color: #000;" class="fa fa-search"></i></button>
