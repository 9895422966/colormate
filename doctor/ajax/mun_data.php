  ...
  $m=mysqli_query($connect,"select * from localbody where dist_id='$dist_id' and lb_type='M';"); 

?>
                              <table id="municipality" class="table table-striped table-bordered" >
                                <thead>
                                    <tr>
                                        <tr>
                                           <th><i class="icon_pin_alt"></i>Code</th>                                         <th><i class="icon_pin_alt"></i>Municipality</th>
